...
import { EmailOutlined, MailOutlineRounded, MailRounded, PermPhoneMsgOutlined } from '@mui/icons-material';
import { academicQualification, contactInfo, experience, projects } from '@/src/shared/contents/homeContent';
    ...
    return (
        <ThemeProvider theme={customMuiTheme}>
            <div className='mainHome'>
                ...
                <Grid container p={10} bgcolor={appColors.light} columnSpacing={5}>

                    {/* Main left grid view */}
                    <Grid item md={6} xs={12}>
                        <Box bgcolor={appColors.container_bg} borderRadius={15}>
                            <Typography color={"black"} p={5} lineHeight={3} paragraph>
                                {decriptionContent}
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid item md={6} xs={12}>
                        ...
                        <Grid container rowSpacing={5}>
                            ...
                            {/* Contact me */}
                            <Grid item xs={12}>
                                <Box bgcolor={appColors.container_bg} borderRadius={15} p={3} color={appColors.dark}>
                                ...
                                <CustomBox>
                                    ...
                                    {/* List of academic years */}
                                    {
                                        academicQualification.map((academyItem, index) => {
                                            return <CustomStack>
                                                <Image
                                                    src={academyItem.type == "School" ? SchoolIcon : CollegeIcon}
                                                    alt='Academy icon'
                                                    height={50}
                                                    width={50}
                                                />
                                                ...
                                                <Stack direction={'column'}>
                                                    <Typography color={appColors.dark}>
                                                        <strong>
                                                            {academyItem.qualification}{" "}
                                                        </strong>
                                                    </Typography>
                                                    <Typography color={appColors.brown}>
                                                        <strong>
                                                            {academyItem.percentage}{" "}
                                                        </strong>
                                                    </Typography>
